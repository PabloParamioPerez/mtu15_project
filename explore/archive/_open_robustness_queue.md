> **ARCHIVED 2026-04-25.** Items in this queue were either executed in the 2026-04-25 robustness sweep (results migrated to `archive/_robustness_summary.md` and to `/CLAIMS_LEDGER.md`) or have been re-prioritised in `explore/_modelling_track.md` Phase 2 candidates.
