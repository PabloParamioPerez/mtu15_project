> **ARCHIVED 2026-04-25.** Per-claim status migrated to `/CLAIMS_LEDGER.md` and to nb12/nb13 canonical-headline cells. The §-level provenance (§1–§13) is preserved here for the viva trail; the live ledger references each section by `archive/_robustness_summary.md §X`.
