...
| [09_bid_shape_eda.ipynb](09_bid_shape_eda.ipynb) | 20 | Bid-structure EDA. §1 DA tranches per offer-period by regime × group × tech; §2 monthly time series; §3 IDA tranches (H12 test); §4 DA+IDA side-by-side with reform verticals; §5 IDA tranche-price range (H13 test); §6 IDA supply-function slope (H14, Chang 2026-style). | H10 Big-4 CCGT DA median tranches drops 5-7 → 1-2 at MTU15-IDA. H12 SUPPORTED descriptively: DA simplification mirrored by IDA complexification. H13 REJECTED: new IDA tranches are quantity-precision (median range 0-3 EUR/MWh), not strategic spread. H14 SUPPORTED: Big-4 CCGT IDA supply slope flattens 4.24 → 13.3 across reforms; Big-4/Fringe gap inverts at MTU15-IDA. |
