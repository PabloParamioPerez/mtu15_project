...
Every aggregate claim in the project that has been unit-decomposed has dissolved under decomposition: H5 (DiD pre-trends), H6 (wind-IV nuclear weighting), H7 (GE×CCGT placebo), H18 (MUEL/UFBG composition). The appropriate next step for any remaining descriptive finding (H10, H12, H14, H15) is systematic unit-level audit before further claims.
