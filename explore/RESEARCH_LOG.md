...
| **H18** | Big-4 Pumped Hydro uses iceberg orders to hide XBID strategic positioning, increasingly post-MTU15-DA | **[SUPPORTED — descriptive + placebo-validated; plant-level concentration]** | `nb09 §8a`, `§9`, `§10`. Iceberg rate = fraction of XBID sell orders with `exec_condition='ICE'`. Big-4 Pumped Hydro: 40% (6-sess) → 47% → 60% → 58% → **98.8% (DA15/ID15 post-MTU15-DA)**. **§9 PLACEBO: survives sliding-boundary test** — real MTU15-DA Δ = 0.480, non-reform placebo Δ range [0.210, 0.327], empirical p = 0/18 = 0.000. **§10 concentration check:** 98.3% of post-MTU15-DA orders come from **ONE unit: Iberdrola's La Muela (MUEL, ~630 MW, Spain's largest pumped-storage)**. "Big-4 Pumped Hydro" aggregate is effectively "La Muela". **Sell–buy asymmetry**: Sell-side reaches 98.8%, buy-side only 67.5%. Mechanism (§10): (1) pumped hydro's finite reservoir creates cross-interval dependency that iceberg hides; (2) MTU15-DA aligned DA-XBID price linkage at 15-min, raising information leakage per visible order; (3) sell-side hides more than buy-side because peak-price information has higher value (market-power asymmetry); (4) La Muela dominates because it's the largest + Iberdrola has the most sophisticated XBID trading desk. Fringe CCGT 17-37% → 78-87% at MTU15-IDA is a second candidate pattern (not yet placebo-tested). |
| **H17** | Demand-side offers (retailers, direct consumers, last-resort retailers) exhibit strategic bidding patterns analogous to generator withholding | [UNTESTED — directly actionable, fully unexplored] | Quick inventory: 382k demand-side DA offers (buy_sell='C') across 717 units in 2024+, vs 1.37M sell offers from 2,930 units. Demand side is ~27% of DA offer activity. Units include COMERCIALIZADOR (705), CONSUMIDOR DIRECTO (156), COMERCIALIZADOR ULTIMO RECURSO (7). Strategic demand bidding is symmetric to withholding: over-bid DA demand to reserve quantity + sell back in IDA, or under-bid DA + buy in IDA. nb03–nb09 have ignored the buy side entirely. **Proposed next target** — requires its own section (possibly nb10) because it needs a fresh panel with buy-side firm attribution. |
...
| [09_bid_shape_eda.ipynb](09_bid_shape_eda.ipynb) | 32 | Bid-structure EDA. §1-§2 DA tranche counts; §3-§4 IDA tranches (H12); §5 IDA price-range (H13); §6 supply-function slope (H14); §7 within-hour bid similarity (H15); §8 XBID iceberg + storage (H18, H16); §9 placebo for H18; §10 economic rationalization + per-unit decomposition. | H18 placebo-validated (project's first). §10 narrows the claim: the "Big-4 Pumped Hydro" 99% iceberg rate is almost entirely **Iberdrola's La Muela** (98.3% of post-reform orders). Mechanism fits: pumped hydro's reservoir constraint + MTU15-DA's DA-XBID price linkage at 15-min + peak-price sell asymmetry + La Muela's size/Iberdrola's trading desk sophistication. |
...
### 8.2.1 Placebo-validated finding (new after nb09 §9)

**Big-4 Pumped Hydro XBID iceberg-order adoption is pinned to MTU15-DA (2025-10-01).** Monthly iceberg rate is volatile 24–92% across the 23 pre-MTU15-DA months and saturated 97–100% across the 4 post-reform months. Sliding-boundary placebo sweep: real MTU15-DA Δ = 0.480 vs non-reform placebo range [0.210, 0.327]; empirical p = 0/18 = 0.000. This is a *descriptive* causal-like claim (no counterfactual firm) but with placebo localisation rigor that matches modern-DiD standards for natural-experiment step changes.
