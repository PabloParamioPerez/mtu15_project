...
**Methodology lineage**: Pigou (1920) Article 9.6 of EU GL EB imbalance-settlement methodology; Borenstein–Bushnell (2015 RAND) on settlement-rule design.
...
> **Layer 1 (Part I, system).** The reform created a regulatorily-induced settlement friction during the asymmetric-granularity window. €1.1B flowed from BRPs to the TSO over 10 months. This friction RESOLVED at MTU15-DA when granularity symmetry was restored.
>
