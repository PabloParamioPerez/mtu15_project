...
Not thesis output. The notebooks and markdown docs here carry the analysis that feeds the thesis. Thesis-grade synthesis lives in [`thesis/drafts/master_thesis_proposal.md`](../thesis/drafts/master_thesis_proposal.md).
...
- **[`/thesis/drafts/master_thesis_proposal.md`](../thesis/drafts/master_thesis_proposal.md)** — 5-part synthesis (system friction → IB structural → cross-market specialisation → CNMC enforcement → behavioural appendix). Written 2026-04-28.
...
| 14 | ALIVE (provisional) | Early thesis figures (3). Superseded for May presentation by [`thesis/presentation2/figures.ipynb`](../thesis/presentation2/figures.ipynb). |

The May 2026 preliminary-results notebook (5 figures: S5, S6, B6, B7, S6 blackout-split) **lives outside `explore/`** in [`thesis/presentation2/`](../thesis/presentation2/) so that presentation-deliverable source artefacts stay separate from exploratory work.
