...
- `thesis/figures/fig01_S5_four_panel_concordance.{pdf,png}` — Slide I.2
- `thesis/figures/fig02_S6_settlement_transfer_headline.{pdf,png}` — Slide I.3
- `thesis/figures/fig03_B6_passthrough_by_regime.{pdf,png}` — Slide I.4
- `thesis/figures/fig04_B7_france_placebo.{pdf,png}` — Slide I.5
- `thesis/figures/fig05_S6_blackout_robustness.{pdf,png}` — backup
- `thesis/figures/fig06_S7_pigouvian_incidence.{pdf,png}` — Slide I.5
- `thesis/figures/fig07_burden_share_regime_invariance.{pdf,png}` — backup
- `thesis/figures/fig08_model_propositions.{pdf,png}` — synthesis (probably stale, may need rework)
- `thesis/figures/fig09_B9_perfirm_q2_trajectory.{pdf,png}` — Slide II.3 ✓ (new)
