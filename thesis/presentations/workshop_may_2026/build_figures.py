...
Run once: `uv run python thesis/presentations/workshop_may_2026/build_figures.py`
...
which regenerates `figures/thesis/fig01..fig05.{pdf,png}`.

Both this builder and the produced notebook live under `thesis/presentations/workshop_may_2026/` so
...
# This file lives at thesis/presentations/workshop_may_2026/build_figures.py; project root is parents[2].
PROJECT = Path(__file__).resolve().parents[2]
OUT_NB = PROJECT / "thesis/presentations/workshop_may_2026/figures.ipynb"
...
These are off-arc for the May talk by deliberate choice. Several supporting documents (`thesis/proposal.md`, `explore/_modelling_track.md`, `CLAIMS_LEDGER.md`, `explore/_audits.md`) flesh out Parts II–V for thesis-grade defense.
...
This is the system-layer reform impact, decomposed into scale and structure. The thesis as a whole maps three additional IO channels (firm-level Cournot-pivotality, cross-market firm specialisation, post-CNMC strategic-availability conduct) — covered in Parts II–IV of [`thesis/proposal.md`](../drafts/master_thesis_proposal.md) but **off-arc for this preliminary-results talk**.
...
Today's findings are **Part I** of a broader 4-part synthesis covering 37 alive empirical claims. The full structure (in [`thesis/proposal.md`](../drafts/master_thesis_proposal.md)):
...
PROJECT = Path('../..').resolve()  # notebook lives at thesis/presentations/workshop_may_2026/; project root is two levels up
...
s6 = pd.read_csv(PROJECT/'results/regressions/s6_monthly_decomposition.csv')
...
sens = pd.read_csv(PROJECT/'results/regressions/s6_baseline_sensitivity.csv')
...
code("""
b6 = pd.read_csv(PROJECT/'results/regressions/b5_seasonality_audit.csv')
...
s7 = pd.read_csv(PROJECT/'results/regressions/pigouvian_clean_results.csv')
