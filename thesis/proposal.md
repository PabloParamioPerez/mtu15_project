# Master thesis proposal — economic structure for 41 alive findings

**Date:** 2026-04-28; revised 2026-05-02 after the F1/F2/F3/F5 kill pass + F7/F14–F22 re-sectioning + PDBF-gap closure (B10/B11/D6/F24/F26/D7/D8 added) + attack-pass on regression-backed claims (B9 confirmed robust under canonical Fabra-Imelda; B11 wounded from −41.7% → ~−12% under wider-window robustness; F25 killed via mechanism decomposition; F26 wounded — Q1 2024 break, not at IDA reform; D8 added — renewable-saturation correlation, nuclear-specific). Counts: **41 alive · 7 wounded · 20 dead · 68 active rows**. Working draft. To be discussed and refined.

**One-sentence thesis claim.** Spain's 2024–2025 reform sequence (6→3 IDA sessions; MTU15-IDA; MTU15-DA) reveals **three distinct mechanism-design observations** about a power market in transition: (1) **asymmetric-clock friction** during the 10-month asymmetric-granularity window generated a ~€1.1B BRP→TSO settlement transfer that collapses cleanly at MTU15-DA; (2) **non-Pigouvian segment incidence** under uniform dual-pricing settles wind + LIB free-market retailers with 60–65% of imbalance cost in every post-ISP15 regime regardless of clock symmetry; (3) **operational-regime overlay** — the post-2025-04-28 *operación reforzada* runs continuously alongside the market layer (~€666M direct cost, €3.77B RRTT in 2025), forcing ~20–30 CCGTs + nuclear daily via PO-3.2 RRTT and creating the new PO-7.4 zonal reactive market — a missing-market patch that the markets-side reform (MTU15) cannot reach. Underneath these three reform-driven observations, firm-level market power persists regime-invariant: IB extracts ~€820M of DA-clearing rent through hydro Cournot dispatch; cross-market specialisation (IB in DA hydro, GE in aFRR, Naturgy in CCGT redispatch) sharpens after the blackout without reordering.
