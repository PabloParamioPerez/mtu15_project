...
\midrule
\multicolumn{5}{l}{\textit{Post $\times$ Critical ($\theta$), by technology:}} \\[1pt]
...
$N$ (CCGT)       & $50{,}824$  & $159{,}669$ & $50{,}824$  & $159{,}669$ \\
$N$ (Hydro)      & $81{,}567$  & $132{,}822$ & $81{,}567$  & $132{,}822$ \\
$N$ (Hydro pump) & $17{,}959$  & $25{,}207$  & $17{,}959$  & $25{,}207$  \\
\bottomrule
\end{tabular}
\end{center}
...
\paragraph{Reading.}
\textit{(Gap. Per-tech heterogeneity is large and economically meaningful. (i) ID15 --- CCGT responds strongest on both margins ($\sigma_p$ $+2.45^{***}$, $N_{\text{eff}}$ $+0.79^{***}$); Hydro reservoir intermediate; pump-storage tiny/null on $\sigma_p$ but small positive on $N_{\text{eff}}$. (ii) DA15 --- the leader flips: Hydro reservoir takes the largest $\sigma_p$ response ($+1.69^{***}$), CCGT only marginally significant on $\sigma_p$ ($+1.30^{*}$) but dominant on $N_{\text{eff}}$ ($+0.44^{***}$); pump-storage NEGATIVE on $\sigma_p$ ($-0.63^{*}$). (iii) The pooled estimate hides the heterogeneity --- e.g. ID15 $N_{\text{eff}}$ pooled $+0.10$ is null, but CCGT alone is $+0.79^{***}$ and Hydro $+0.21^{***}$. The contrast between ID15 (CCGT-led) and DA15 (Hydro-led on $\sigma_p$, CCGT-led on $N_{\text{eff}}$) deserves a paragraph: each reform reshapes a different lever.)}
