...
single-point bid at the Cournot quantity), we follow the reviewer's
suggestion and put the demand uncertainty \emph{before} the bid: the
firm commits its schedule $(p^L_q, k^L_q, p^H_q)$ before $\mu_q$
realises. After posting, $\mu_q \sim \mathrm{Uniform}[-\Delta_\mu,
