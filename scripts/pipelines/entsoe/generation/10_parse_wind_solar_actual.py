...
from mtu.parsing.entsoe.wind_solar_actual import parse_file  # noqa: E402
...
PARSER_NAME = "entsoe.wind_solar_actual.parse_file"


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Parse ENTSO-E A75 actual wind & solar generation XMLs into per-month Parquet."
    )
