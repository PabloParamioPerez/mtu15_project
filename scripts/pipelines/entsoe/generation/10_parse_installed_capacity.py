...
from mtu.parsing.entsoe.installed_capacity import parse_file  # noqa: E402
...
PARSER_NAME = "entsoe.installed_capacity.parse_file"


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Parse ENTSO-E A68 installed capacity XMLs into per-year Parquet."
    )
