...
CATEGORY = "wind_solar_forecast"
FILE_FAMILY = "wind_solar_forecast"
PARSER_NAME = "entsoe.wind_solar_forecast.parse_file"


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Parse ENTSO-E A69 wind & solar forecast XMLs into per-month Parquet."
    )
...
def main() -> None:
    ...
    raw_dir = PROJECT_ROOT / "data/raw/entsoe/generation/wind_solar_forecast"
    processed_dir = PROJECT_ROOT / "data/processed/entsoe/generation/wind_solar_forecast"
