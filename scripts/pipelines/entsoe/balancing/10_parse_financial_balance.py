...
from mtu.parsing.entsoe.financial_balance import parse_file  # noqa: E402
...
PARSER_NAME = "entsoe.financial_balance.parse_file"


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Parse ENTSO-E A87 XMLs into per-month Parquet."
    )
    p.add_argument(
        "--overwrite",
        action="store_true",
