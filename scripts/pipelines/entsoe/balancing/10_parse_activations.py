...
from mtu.parsing.entsoe.activations import parse_file  # noqa: E402
...
FILE_FAMILY = "activated_prices"
PARSER_NAME = "entsoe.activations.parse_file"


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Parse ENTSO-E A84 activated prices XMLs into per-month Parquet."
    )
...
def main() -> None:
    ...
    raw_dir = PROJECT_ROOT / "data/raw/entsoe/balancing/activations"
