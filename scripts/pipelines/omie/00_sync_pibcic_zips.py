...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Download and extract OMIE PIBCIC monthly ZIP archives (idempotent with recent-month refresh)"
    )
...
def main() -> None:
    ...
    raw_dir = PROJECT_ROOT / "data/raw/omie/mercado_intradiario_continuo/programas/pibcic"
