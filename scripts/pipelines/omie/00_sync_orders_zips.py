...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description=(
            "Download and extract OMIE ORDERS monthly ZIP archives (idempotent). "
            "orders_YYYYMMDD.v files contain individual orders submitted to the "
            "continuous intraday market (§5.3.3.1). Subject to 90-day confidentiality."
        )
    )
...
def main() -> None:
    ...
    raw_dir = PROJECT_ROOT / "data/raw/omie/mercado_intradiario_continuo/ofertas/orders"
