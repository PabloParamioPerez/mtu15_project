...
def main() -> None:
    processed_dir = PROJECT_ROOT / "data/processed/omie/mercado_diario/capacidades/capacidad_inter_pvp"
    output_path = processed_dir.parent / "capacidad_inter_pvp_all.parquet"
