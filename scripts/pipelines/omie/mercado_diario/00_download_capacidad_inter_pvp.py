...
PARENTS_VALUE = "capacidad_inter_pvp"
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description=(
            "Download OMIE CAPACIDAD_INTER_PVP files (idempotent). "
            "capacidad_inter_pvp_YYYYMMDD.v files contain interconnection capacity "
            "and occupation after technical restrictions of the day-ahead market, "
            "per period and border (§5.1.6.2). No confidentiality window."
        )
    )
...
def main() -> None:
    ...
    raw_dir = PROJECT_ROOT / "data/raw/omie/mercado_diario/capacidades/capacidad_inter_pvp"
