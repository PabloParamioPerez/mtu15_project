...
# Make src/ importable when running: uv run python scripts/parse_marginalpdbc.py
...
from mtu.parsing.mercado_diario.marginalpdbc import parse_folder_and_write  # noqa: E402


def main() -> None:
    raw_dir = PROJECT_ROOT / "data/raw/omie/mercado_diario/precios/marginalpdbc"
    processed_dir = PROJECT_ROOT / "data/processed/omie/mercado_diario/precios/marginalpdbc"
