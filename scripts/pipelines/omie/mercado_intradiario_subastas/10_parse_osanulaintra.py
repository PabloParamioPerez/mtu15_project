...
from mtu.parsing.mercado_intradiario_subastas.osanulaintra import parse_folder_and_write  # noqa: E402


def main() -> None:
    raw_dir = PROJECT_ROOT / "data/raw/omie/mercado_intradiario_subastas/anulaciones/osanulaintra"
    processed_dir = PROJECT_ROOT / "data/processed/omie/mercado_intradiario_subastas/anulaciones/osanulaintra"
