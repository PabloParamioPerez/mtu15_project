...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Download and extract OMIE PIBCI monthly ZIP archives (idempotent with recent-month refresh)"
    )
...
def main() -> None:
    ...
    raw_dir = PROJECT_ROOT / "data/raw/omie/mercado_intradiario_subastas/programas/pibci"
