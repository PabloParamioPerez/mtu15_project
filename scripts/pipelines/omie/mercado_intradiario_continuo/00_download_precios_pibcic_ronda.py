...
PARENTS_VALUE = "precios_pibcic_ronda"
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Download OMIE PRECIOS_PIBCIC_RONDA daily files")
...
def main() -> None:
    ...
    raw_dir = PROJECT_ROOT / "data/raw/omie/mercado_intradiario_continuo/precios/precios_pibcic_ronda"
    ...
    print(
        f"Downloading PRECIOS_PIBCIC_RONDA from {start_date} to {end_date} "
