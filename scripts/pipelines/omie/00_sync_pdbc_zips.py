...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Download and extract OMIE PDBC monthly ZIP archives (idempotent)"
    )
...
def main() -> None:
    ...
    raw_dir = PROJECT_ROOT / "data/raw/omie/mercado_diario/programas/pdbc"
    ...
    for period in months_range(args.start_month, args.end_month):
