...
# FEEDS: (modelling-track welfare input)
# CLAIM: Producer surplus proxy: fraction of cleared revenue from high-price IDA bid tranches
...
# Save panel
df.to_parquet('data/derived/panels/welfare_proxy_panel.parquet', index=False)
print(f'\nSaved {len(df):,}-row panel to data/derived/panels/welfare_proxy_panel.parquet')
