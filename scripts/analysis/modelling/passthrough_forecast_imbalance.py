...
# FEEDS: B6
# CLAIM: Forecast-error -> imbalance pass-through regression by regime
...
Economic model the regression motivates:
  ...
  Output: data/derived/panels/passthrough_panel.parquet plus regression table.
"""
...
panel.to_parquet('data/derived/panels/passthrough_panel.parquet', index=False)
