...
# FEEDS: F1, F2, F3, F4, W1
# CLAIM: Hourly firm-level Cournot-Nash Lerner-index panel for Big-4
...
Output: data/derived/panels/firm_lerner_hourly.parquet
...
SLOPE_PANEL = 'data/derived/panels/supply_slope_hourly.parquet'
PDBCE = 'data/processed/omie/mercado_diario/programas/pdbce_all.parquet'
OUT = Path('data/derived/panels/firm_lerner_hourly.parquet')
