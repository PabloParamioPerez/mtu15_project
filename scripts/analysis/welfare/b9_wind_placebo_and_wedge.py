...
Outputs:
   data/derived/results/b9_wind_placebo.csv
   data/derived/results/b9_da_ida_wedge.csv
"""
...
OUT_WIND = PROJECT / "data" / "derived" / "results" / "b9_wind_placebo.csv"
OUT_WEDGE = PROJECT / "data" / "derived" / "results" / "b9_da_ida_wedge.csv"
