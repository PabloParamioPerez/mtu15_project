...
Outputs:
  data/derived/firm_tech_share_panel.parquet
  data/derived/firm_ccgt_lerner_panel.parquet
"""
...
SLOPE = Path('data/derived/supply_slope_hourly.parquet')
...
con.execute(f"""
    ...
    ) TO 'data/derived/firm_ccgt_lerner_panel.parquet' (FORMAT PARQUET)
""")
...
df = con.sql("""
    ...
    FROM 'data/derived/firm_ccgt_lerner_panel.parquet'
