...
# FEEDS: F1
# CLAIM: Compare GE/IB Lerner pre-blackout vs same calendar weeks 1-2 years earlier
...
LER = Path('data/derived/panels/firm_lerner_hourly.parquet')
SLP = Path('data/derived/panels/supply_slope_hourly.parquet')
