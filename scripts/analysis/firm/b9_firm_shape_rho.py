...
B9_PERFIRM = PROJECT / "results" / "regressions" / "b9_replicated_isp_grain_perfirm.csv"
OUTDIR   = PROJECT / "results" / "regressions" / "b9_firm_shape_rho"
...
def main() -> None:
    ...
    try:
        ...
        FIG_DIR = PROJECT / "figures" / "thesis"
