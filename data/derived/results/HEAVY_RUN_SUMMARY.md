...
Output: `data/derived/results/b9_combined_total/`
...
Output: `data/derived/results/b9_hour_of_day/`
...
Output: `data/derived/results/b9_firm_shape_rho/`
Figure: `thesis/figures/fig_prop5_rho_vs_compression.{pdf,png}`
...
Output: `data/derived/results/b9_continuous_market/`
...
Output: `data/derived/results/b9_block_bid_intensity/`
