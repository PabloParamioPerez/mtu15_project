...
**Connection back to the thesis proposal.** Part IV anchor — see `thesis/proposal.md` § Part IV. The within-firm fleet-substitution framing is the thesis's structural extension of the CNMC's cross-firm SBO3 framework.
