> **ARCHIVED 2026-04-25.** Replaced by `explore/_modelling_track.md`. The economic-modelling sections are reorganised in the live track; surviving alive claims sourced from this file (e.g. forecast-error pass-through R² jump) now live as rows in `/CLAIMS_LEDGER.md` (B6).
